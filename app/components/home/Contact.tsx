    ...
    return (
        ...
        >
            <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-[1.8fr_2.1fr] lg:gap-24">
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="max-w-4xl">
                            ...
                            <p className="mt-6 max-w-2xl text-base leading-7 text-white/60 sm:text-lg">
                                ...
                                support inclusive development or explore a partnership, we&apos;d
                                love to hear from you. There is a place for you in our ecosystem.
                            </p>
                        </div>
                    </div>
                </motion.div>
                ...
                {/* Form */}
                <div>
                    <p className="mb-5 text-sm font-semibold uppercase tracking-[0.25em] text-[#d6ad72]">
                        Get in touch
                    </p>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full border-b border-white/30 bg-transparent px-0 py-4 text-base text-white outline-none transition placeholder:text-white/60"
                            />
                        </div>
                        ...
                        <button
                            ...
                            className="inline-flex cursor-pointer rounded-full border border-white/30 bg-[#315B3A] px-7 py-4 text-sm font-semibold text-white transition hover:bg-[#25482d] disabled:cursor-not-allowed disabled:opacity-60"
                        >
